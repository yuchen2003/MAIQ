...
def run_sample(_run, _config, _log):
    ...
    if args.env == 'sc2':
        args.save_dataset_dir = os.path.join(args.save_dataset_dir, _config['env_args']['map_name'] + '_' + args.mixer + '_' + str(args.episode_cnt) + '.pkl')
    else:
        args.save_dataset_dir = os.path.join(args.save_dataset_dir, _config['env_args']['key'] + '_' + '_' + str(args.episode_cnt) + '.pkl')
    args.load_dataset_dir = args.save_dataset_dir
...
def run_sequential(args, logger):
    ...
    if args.checkpoint_path == "" or args.checkpoint_path == None:
         logger.console_logger.info("Please load model before start sampling")
         return
