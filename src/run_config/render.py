...
def run_render(_run, _config, _log):
    ...
    #args.save_dataset_dir = os.path.join(args.save_dataset_dir, _config['env_args']['map_name'] + '_' + args.mixer + '_' + str(args.buffer_size) + '.pkl')
...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "actions": {"vshape": (2,), "group": "agents", "dtype": th.float32},
    ...
    # buffer.load(args.load_dataset_dir)
